...
class XetraSourceConfig(NamedTuple):
  ...
  src_first_extract_date: determine the date for extracting the source
  ...
  src_col_traded_vol: scolumn name for traded volume in sourcetr
  """
...
class XetraETL():
  """
  Reads the Xetra data, transformes and writes the transformed to target
  """
